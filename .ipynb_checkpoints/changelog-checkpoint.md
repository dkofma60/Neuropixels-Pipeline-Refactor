...
model_predictions:
- Section 2 (data loading and exploration): Reduced runtime error rate from 21% -> 0% ([# cells resulting in runtime error]/[# total cells]), fixed other design flaws/bugs, streamlined code
